...
export const FALLBACK_MEMBER_MODULES: NavModule[] = [
  ...
  { code: 'MEMBER_SUPPORT', title: 'Group Chat', routePath: 'chat', icon: 'pi pi-comments', sortOrder: 8 },
  { code: 'MEMBER_HELP', title: 'Help', routePath: 'help', icon: 'pi pi-question-circle', sortOrder: 9 },
  { code: 'MEMBER_ABOUT_US', title: 'About Us', routePath: 'about-us', icon: 'pi pi-info-circle', sortOrder: 10 },
...
export const FALLBACK_SOCIETY_MODULES: NavModule[] = [
  ...
  { code: 'SOCIETY_POLLS', title: 'Polls', routePath: 'polls', icon: 'pi pi-chart-pie', sortOrder: 9 },
