...
export const FALLBACK_MEMBER_MODULES: NavModule[] = [
  ...
  { code: 'MEMBER_SUPPORT', title: 'Support', routePath: 'support', icon: 'pi pi-question-circle', sortOrder: 3 },
];
...
export const FALLBACK_SOCIETY_MODULES: NavModule[] = [
  ...
  { code: 'SOCIETY_SETTINGS', title: 'Settings', routePath: 'settings', icon: 'pi pi-cog', sortOrder: 8 },
  { code: 'SOCIETY_SUPPORT', title: 'Support', routePath: 'support', icon: 'pi pi-question-circle', sortOrder: 9 },
];
